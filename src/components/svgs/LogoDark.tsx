...
const LogoDark: FC<React.SVGAttributes<ReactSVGElement>> = () => {
    return (
        <svg width="858" height="290" viewBox="0 0 858 290" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M323.727 238.52H363.373V161.058H439.645V128.37H363.373V83.6878H447.885V51H323.727V238.52Z" fill="black"/>
            <path d="M467.411 83.6878H524.821V238.52H564.009V83.6878H621.419V51H467.411V83.6878Z" fill="black"/>
